...
public class BillTest {
    ...
    public void testGiftNumeroMaggiorenniMinoriDieci() throws TakeAwayBillException {
    	listaOrdini.add(new OrderItem(new ArrayList<>(), new User(1,"Lorenzo","Perinello",20), Calendar.getInstance(), 100));
    	listaOrdini.add(new OrderItem(new ArrayList<>(), new User(1,"Lorenzo","Perinello",20), Calendar.getInstance(), 550));
    	listaOrdini.add(new OrderItem(new ArrayList<>(), new User(1,"Lorenzo","Perinello",20), Calendar.getInstance(), 777));
    	listaOrdini.add(new OrderItem(new ArrayList<>(), new User(1,"Lorenzo","Perinello",20), Calendar.getInstance(), 100));
    	listaOrdini.add(new OrderItem(new ArrayList<>(), new User(1,"Lorenzo","Perinello",20), Calendar.getInstance(), 696));
    	listaOrdini.add(new OrderItem(new ArrayList<>(), new User(1,"Lorenzo","Perinello",20), Calendar.getInstance(), 100));
    	listaOrdini.add(new OrderItem(new ArrayList<>(), new User(1,"Lorenzo","Perinello",20), Calendar.getInstance(), 420));
    	listaOrdini.add(new OrderItem(new ArrayList<>(), new User(1,"Lorenzo","Perinello",20), Calendar.getInstance(), 100));
    	listaOrdini.add(new OrderItem(new ArrayList<>(), new User(1,"Lorenzo","Perinello",20), Calendar.getInstance(), 160));
    	listaOrdini.add(new OrderItem(new ArrayList<>(), new User(1,"Lorenzo","Perinello",20), Calendar.getInstance(), 190));
    	listaOrdini.add(new OrderItem(new ArrayList<>(), new User(1,"Lorenzo","Perinello",20), Calendar.getInstance(), 100));
		Random n = new Random();
		boolean gifting = n.nextBoolean();
    	listaOrdini = bill.gift(listaOrdini, gifting);
